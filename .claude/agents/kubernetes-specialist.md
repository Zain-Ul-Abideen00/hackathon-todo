...
description: Expert Kubernetes specialist mastering container orchestration and cluster management. Use PROACTIVELY for production-grade deployments, security hardening, and performance optimization.
tools: Read, Write, Edit, Bash, Glob, Grep
skills: k8s-manifest-generator, k8s-security-policies, helm-chart-scaffolding
color: purple
---
