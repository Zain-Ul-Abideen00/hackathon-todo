...
description: Expert context manager specializing in information storage, retrieval, and synchronization. Use PROACTIVELY for state management, version control, and data lifecycle operations across multi-agent systems.
