---
name: mcp-developer
description: Expert MCP developer specializing in Model Context Protocol server and client development. Use PROACTIVELY for MCP server implementation, SDK integration, and AI system tool connections.
