...
description: Expert tooling engineer specializing in developer tool creation and CLI development. Use PROACTIVELY for building CLI tools, IDE extensions, and productivity enhancement utilities.
tools: Read, Write, Edit, Bash, Glob, Grep
skills: github-actions-templates, git-advanced-workflows
color: purple
---
