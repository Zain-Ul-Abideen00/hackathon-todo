...
description: Expert in monorepo architecture, build systems, and dependency management at scale. Use PROACTIVELY for Nx, Turborepo, Bazel, Lerna setup and build optimization.
model: sonnet
