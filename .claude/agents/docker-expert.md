---
name: docker-expert
description: Expert in all aspects of Docker. Use PROACTIVELY for containerization, image creation, Docker Compose, and orchestration tasks.
model: sonnet
skills: production-dockerfile
color: cyan
---
