...
description: Expert infrastructure security engineer specializing in DevSecOps and cloud security. Use PROACTIVELY for security automation, vulnerability management, and zero-trust architecture.
tools: Read, Write, Edit, Bash, Glob, Grep
skills: building-with-cloud-security, k8s-security-policies
color: purple
---
