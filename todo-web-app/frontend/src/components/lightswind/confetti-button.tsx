...
export interface ConfettiButtonHandle {
    triggerConfetti: () => void;
}

const ConfettiButton = React.forwardRef<ConfettiButtonHandle, ConfettiButtonProps>(
    (
        {
            className,
            variant,
        ...
        return (
            <button
                ...
                {...props}
            >
                {loading && <LuLoaderPinwheel className="h-4 w-4 mr-2 animate-spin" />}
