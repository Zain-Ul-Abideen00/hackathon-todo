...
const SelectValue = React.forwardRef<HTMLSpanElement, SelectValueProps>(
	({ className, placeholder, children, ...props }, ref) => {
		...
		const parentChildren =
			(context as any).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED?.children || children;
		...
		return (
			<span ref={ref} className={cn("text-sm", className)} {...props}>
				{content || <span className="text-muted-foreground">Select an option</span>}
			</span>
		);
	},
);
...
const SelectScrollUpButton: React.FC<React.HTMLAttributes<HTMLDivElement>> = (props) => (
	<div {...props} />
);
SelectScrollUpButton.displayName = "SelectScrollUpButton";

const SelectScrollDownButton: React.FC<React.HTMLAttributes<HTMLDivElement>> = (props) => (
	<div {...props} />
);
...
const SelectContent = React.forwardRef<HTMLDivElement, SelectContentProps>(
	(
		...
		const [calculatedStyle, setCalculatedStyle] = React.useState<React.CSSProperties>({});
		const [currentSide, setCurrentSide] = React.useState<"top" | "bottom">("bottom");
