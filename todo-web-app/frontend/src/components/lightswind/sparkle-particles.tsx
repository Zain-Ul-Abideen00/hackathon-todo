...
import type { IOptions, MoveDirection, RecursivePartial } from "@tsparticles/engine"; // Import MoveDirection
...
export function SparkleParticles({
	...
	return (
		isEngineReady && <Particles id={instanceId} options={mergedOptions} className={className} />
	);
}
