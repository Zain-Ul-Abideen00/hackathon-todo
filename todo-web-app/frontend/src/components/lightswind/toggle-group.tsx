...
const ToggleGroup = React.forwardRef<
	HTMLDivElement,
	ToggleGroupProps & Omit<React.HTMLAttributes<HTMLDivElement>, keyof ToggleGroupProps>
>(
	(
		{
			className,
...
const ToggleGroupItem = React.forwardRef<HTMLButtonElement, ToggleGroupItemProps>(
	(
		{ className, children, value, variant, size, disabled: itemDisabled, defaultPressed, ...props },
		ref,
	) => {
		const {
			type,
