"use client";
import { AnimatePresence, type HTMLMotionProps, motion } from "framer-motion"; // Import HTMLMotionProps
		...
		<AnimatePresence>
			{body ? (
				<motion.p
					...
					id={formMessageId}
					className={cn("text-sm font-medium text-destructive overflow-hidden", className)}
