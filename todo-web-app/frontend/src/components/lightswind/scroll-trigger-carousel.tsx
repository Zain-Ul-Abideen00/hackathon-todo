...
const HorizontalCarousel: React.FC<HorizontalCarouselProps> = ({
	...
	return (
		<section ref={targetRef} className="relative bg-background" style={{ height: scrollLength }}>
			{children && <div className="flex h-48 items-center justify-center">{children}</div>}
        ...
        flex items-center justify-center"
			...
			{afterCarouselContent && (
				<div className="flex h-48 items-center justify-center">{afterCarouselContent}</div>
			)}
		</section>
	);
};
