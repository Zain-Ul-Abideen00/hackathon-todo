...
export const GlowingCard: React.FC<GlowingCardProps> = ({
    ...
    return (
        <div
            className={cn(
                "relative flex-1 min-w-[14rem] p-6 rounded-3xl text-black dark:text-white bg-card ",
                "border backdrop-blur-md border-primary/20  transition-all duration-300 shadow-sm hover:shadow-md ",
    ...
    return (
        <div className={cn("relative w-full", className)} style={containerStyle}>
            ...
            >
                ...
                <div
                    className={cn(
                        !containerClassName && "flex items-center justify-center flex-wrap gap-[var(--gap)]",
                        !containerClassName && responsive && "flex-col sm:flex-row ",
                        containerClassName
                    )}
                >
                    {children}
                ...
                {enableGlow && (
                    ...
                    >
                        <div
                            className={cn(
                                !containerClassName && "flex items-center justify-center flex-wrap gap-[var(--gap)] max-w-[var(--max-width)] center mx-auto",
                                !containerClassName && responsive && "flex-col sm:flex-row",
                                containerClassName
                            )}
                            style={{ padding: "var(--padding)" }}
