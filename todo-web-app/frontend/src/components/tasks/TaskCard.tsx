...
import { TbCalendarMonth as Calendar, TbPencil as Pencil, TbTrash as Trash2 } from "react-icons/tb";
...
import { useDeleteTask, useToggleComplete } from "@/hooks/useTasks";
						...
						<div className="flex items-start gap-3">
							...
							<div className="flex-1 min-w-0">
								<div className="flex items-start justify-between gap-2">
									<Link href={`/tasks/${task.id}/edit`} className="flex-1 min-w-0">
										<h3
											className={cn(
